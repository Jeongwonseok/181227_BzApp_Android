...
public class SRegister extends StringRequest {
    ...
    public SRegister(String ID, String gender, String age, String location, String lReason, String type, String tReason, String sales, Response.Listener<String> listener){
