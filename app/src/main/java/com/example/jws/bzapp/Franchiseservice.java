...
public class Franchiseservice extends AppCompatActivity {
    ...
    class FranchiseList extends AsyncTask<Void, Void, String> {
        ...
        public void show(String s) {
            ...
            RecyclerView.LayoutManager manager = new LinearLayoutManager(Franchiseservice.this);
            recyclerView.setLayoutManager(manager);
            RecyclerView recyclerView2 = (RecyclerView) findViewById(R.id.RV2);
            RecyclerView.LayoutManager manager2 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView2.setLayoutManager(manager2);
            RecyclerView recyclerView3 = (RecyclerView) findViewById(R.id.RV3);
            RecyclerView.LayoutManager manager3 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView3.setLayoutManager(manager3);
            RecyclerView recyclerView4 = (RecyclerView) findViewById(R.id.RV4);
            RecyclerView.LayoutManager manager4 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView4.setLayoutManager(manager4);
            RecyclerView recyclerView5 = (RecyclerView) findViewById(R.id.RV5);
            RecyclerView.LayoutManager manager5 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView5.setLayoutManager(manager5);
            RecyclerView recyclerView6 = (RecyclerView) findViewById(R.id.RV6);
            RecyclerView.LayoutManager manager6 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView6.setLayoutManager(manager6);
            RecyclerView recyclerView7 = (RecyclerView) findViewById(R.id.RV7);
            RecyclerView.LayoutManager manager7 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView7.setLayoutManager(manager7);
            RecyclerView recyclerView8 = (RecyclerView) findViewById(R.id.RV8);
            RecyclerView.LayoutManager manager8 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView8.setLayoutManager(manager8);
            RecyclerView recyclerView9 = (RecyclerView) findViewById(R.id.RV9);
            RecyclerView.LayoutManager manager9 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView9.setLayoutManager(manager9);
            RecyclerView recyclerView10 = (RecyclerView) findViewById(R.id.RV10);
            RecyclerView.LayoutManager manager10 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView10.setLayoutManager(manager10);
            RecyclerView recyclerView11 = (RecyclerView) findViewById(R.id.RV11);
            RecyclerView.LayoutManager manager11 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView11.setLayoutManager(manager11);
            RecyclerView recyclerView12 = (RecyclerView) findViewById(R.id.RV12);
            RecyclerView.LayoutManager manager12 = new LinearLayoutManager(Franchiseservice.this);
            recyclerView12.setLayoutManager(manager12);
            RecyclerView recyclerView13 = (RecyclerView) findViewById(R.id.RV13);
            RecyclerView.LayoutManager manager13 = new LinearLayoutManager(Franchiseservice.this);
